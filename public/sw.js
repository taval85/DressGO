...
const APP_SHELL = [
    ...
    'js/libs/plugins/core.string.js',
    'js/libs/plugins/jquery.flips.js',
    'js/libs/plugins/jquery.history.js',    
    'js/libs/plugins/jquery.tmpl.min.js',    
    'js/libs/plugins/jquery.touchSwipe-1.2.5.js',
    'js/libs/plugins/modernizr.custom.08464.js' 
